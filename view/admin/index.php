  ...
  <meta charset="utf-8">
    ...
    <nav class="navbar" >
      <div class="container" >
        ...
        <a class="btn btn-primary" href="facturas.php">Facturas</a>
     ...
     <header class="masthead text-white text-center">
      ...
      <div class="container">  
		...
		<h3>Bienvenido al apartado de Administrador</h3>
        <h3>Para revisar las facturas de los clientes ve al apartado de facturas</h3>
