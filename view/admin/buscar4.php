  ...
  <meta charset="utf-8">
    ...
    <nav class="navbar" >
     ...
     <header class="masthead text-black text-center">
      <h4 class="text-white">
          Presupuesto cubierto hasta la fecha por el usuario en facturas: $
          <?php
          $email = $_POST['user'];
          $conexion = mysqli_connect("127.0.0.1", "u338890849_root", "skatelove1", "u338890849_gerar");
			       
             $sql = "SELECT SUM(cantidad) FROM tbl_documentos WHERE IdUser=(SELECT Id FROM usuarios WHERE email='$email')";
          ...
          $db=new Conect_MySql();
             ...
             $sql = "SELECT * FROM `tbl_documentos` WHERE IdUser=(SELECT Id FROM usuarios WHERE email='$email')";
