  ...
  <meta charset="utf-8">
    ...
    <nav class="navbar" >
      <div class="container" >
        ...
        <a class="btn btn-primary" href="facturas.php">Subir</a>
     ...
     <header class="masthead text-black text-center">
      <h4 class="text-white">
          ...
          $conexion = mysqli_connect("127.0.0.1", "u338890849_root", "skatelove1", "u338890849_gerar");
             ...
             $sql = "SELECT SUM(cantidad) FROM tbl_documentos WHERE IdUser=$id";
          ...
          $db=new Conect_MySql();
             ...
             $sql = "select * from tbl_documentos where IdUser='$id'";
