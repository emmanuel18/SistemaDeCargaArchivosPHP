<?php
  ...
  class Usuario extends Conexion
  {
    ...
    public function registroUsuario($name, $apellido, $numproy, $telefono, $email, $clave)
    {
      parent::conectar();

      $name  = parent::filtrar($name);
      $apellido  = parent::filtrar($apellido);
      $numproy  = parent::filtrar($numproy);
      ...
      if($verificarCorreo > 0){
        echo '<script languaje="javascript">alert("Error... El correo ya está registrado");
